...
public class PlatoEjecutivo {
    ...
    */
    ...
    public PlatoEjecutivo(int IDplatoEJ, int ResNIT, DiaEnum diaSemana, Component entrada, Component principio, Component proteina, Component bebida, int precio, byte[] foto) {
        this.IDplatoEJ = IDplatoEJ;
        this.ResNIT = ResNIT;
        this.diaSemana = diaSemana;
        this.entrada = entrada;
