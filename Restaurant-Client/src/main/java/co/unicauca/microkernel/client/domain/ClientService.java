...
public class ClientService {
    ...
    /**
     * Mascara para guardar un Pedido, esta solicitud se envia al acceso
     * @param  pedido objeto a guardar
     * @return identificador del pedido en caso contrario mensaje de fallo
     * @throws Exception
     */
    ...
    /**
     * Mascara para solicitar lo pedidos, esta solicitud se envia al acceso
